...
//namespace Client
//{
//    class Projectile_old: GameObject
//    {
//        public bool IsActive { get; set; }
//        public event EventHandler<ProjectileHitAnotherPlayerEventArgs> Hit = delegate { };

//        public Projectile_old(Game game, long sessionId, string imageAsset, Vector2 position, float angle, float zOrder, int speed, Vector2 boundsCenterOffset) : base(game, sessionId, imageAsset, position, angle, zOrder, boundsCenterOffset)
//        {
//            Speed = speed;
//            IsActive = true;
//        }
